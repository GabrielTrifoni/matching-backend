...
export class HistoricoDoacaoController {
  constructor(private readonly historicoDoacaoService: HistoricoDoacaoService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateHistoricoDoacaoDto: UpdateHistoricoDoacaoDto) {
